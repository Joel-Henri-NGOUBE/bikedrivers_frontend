...
export default function VehicleForm({vehicleForm, setVehicleForm, isPictureUploaded, setIsPictureUploaded, vehicleId, addVehicle, setUploadedPicture}: IVehicleFormProp){
